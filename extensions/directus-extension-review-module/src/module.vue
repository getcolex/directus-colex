...
// Enhanced parser for fields - handles both JSON array and comma-separated string
// Fixes bug where button interpolation converts arrays to comma-separated strings
const parseFieldsParam = (str, fallback) => {
...
const fields = ref(parseFieldsParam(route.query.fields, []));
